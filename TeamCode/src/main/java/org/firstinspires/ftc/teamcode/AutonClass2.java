...
public class AutonClass2 extends LinearOpMode {
    ...
    public void runProgram(int spikeOveride) throws InterruptedException {
        ...
        //Red Near Center
            ...
            trajMoveU = drive.trajectorySequenceBuilder(new Pose2d(10, -60, Math.toRadians(-90)))
                    .strafeLeft(20)
        ...
        //Red Far Left
            ...
            trajMoveU = drive.trajectorySequenceBuilder(new Pose2d(-35, -60, Math.toRadians(-90)))
